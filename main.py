...
def GET_ADMIN ():
    ...
    output_u = base.execute('SELECT id,nickname,email FROM users').fetchall()
    output_g = base.execute('SELECT id,player_1,player_2,result,deck_1,deck_2,actions FROM games').fetchall()
    base.close()
